...
func (c *Cmd) Prepare(prepare cmd.PrepareFunc) *cobra.Command {
	result := &cobra.Command{
		...
		Short: "Add, remove or update resource labels. Supported resources are: platform, broker, service-instance",
		Long:  "Add, remove or update resource labels. Supported resources are: platform, broker, service-instance",
