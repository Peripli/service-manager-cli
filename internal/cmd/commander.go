...
func AddSupportedEnvironmentFlag(flags *pflag.FlagSet, parameters *query.Parameters) {
	flags.StringVarP(&parameters.Environment, "supported-environment", "e", "any", "Filtering based on the supported environment")
}
